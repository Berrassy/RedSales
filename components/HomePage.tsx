...
interface HomePageProps {
  blackFridayProducts: Product[];
  featuredProducts: Product[];
  almostSoldOutProducts: Product[];
}

export default function HomePage({ 
  blackFridayProducts, 
  featuredProducts, 
  almostSoldOutProducts 
}: HomePageProps) {
  return (
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-yellow-400 text-black px-8 py-4 font-bold text-lg hover:bg-yellow-300 transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
              Voir Tous les Produits
            </button>
            <button className="bg-white text-red-600 px-8 py-4 font-bold text-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
              Contactez-Nous
            </button>
          </div>
        </div>
